...
| **R-010** | Skills parser only extracts from first section | P2 | **OPEN** | Stops at any section header |
...
| **R-013** | `quality_analyzer` crashes with `TypeError` on `None` year | P1 | **OPEN** | Needs null guard on comparison |
